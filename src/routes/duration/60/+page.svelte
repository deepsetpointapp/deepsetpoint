<script>
  ...
  const translations = {
    en: { back: '← Back', title: '60 Minutes Meditation 🌸' },
    fr: { back: '← Retour', title: '60 Minutes Méditation 🌸' },
    de: { back: '← Zurück', title: '60 Minuten Meditation 🌸' },
    pt: { back: '← Voltar', title: '60 Minutos Meditação 🌸' },
    es: { back: '← Volver', title: '60 Minutos Meditación 🌸' },
    it: { back: '← Indietro', title: '60 Minuti Meditazione 🌸' }
  };
