<script>
  ...
  const translations = {
    en: { back: '← Back', title: '90 Minutes Meditation 🌺' },
    fr: { back: '← Retour', title: '90 Minutes Méditation 🌺' },
    de: { back: '← Zurück', title: '90 Minuten Meditation 🌺' },
    pt: { back: '← Voltar', title: '90 Minutos Meditação 🌺' },
    es: { back: '← Volver', title: '90 Minutos Meditación 🌺' },
    it: { back: '← Indietro', title: '90 Minuti Meditazione 🌺' }
  };
...
<div style="position:fixed;top:0;left:0;width:100vw;height:100dvh;z-index:9999;background:black;overflow:hidden;margin:0;padding:0">
  <video 
    bind:this={videoEl}
    src="https://customer-b3ykgf0wdbmm63pk.cloudflarestream.com/28a057a916f3d688236fb8fe01215392/manifest/video.m3u8"
    muted
    autoplay
    playsinline
    loop
