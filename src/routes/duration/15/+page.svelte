<script>
  ...
  const translations = {
    en: { back: '← Back', title: '15 Minutes Meditation 🌱' },
    fr: { back: '← Retour', title: '15 Minutes Méditation 🌱' },
    de: { back: '← Zurück', title: '15 Minuten Meditation 🌱' },
    pt: { back: '← Voltar', title: '15 Minutos Meditação 🌱' },
    es: { back: '← Volver', title: '15 Minutos Meditación 🌱' },
    it: { back: '← Indietro', title: '15 Minuti Meditazione 🌱' }
  };
...
<div style="position:fixed;top:0;left:0;width:100vw;height:100dvh;z-index:9999;background:black;overflow:hidden;margin:0;padding:0">
  <video 
    bind:this={videoEl}
    src="https://customer-b3ykgf0wdbmm63pk.cloudflarestream.com/b02916c67970b39f819b53742ec4ce3e/manifest/video.m3u8"
    muted
    autoplay
    playsinline
    loop
